    ...
    return (
        <DefaultComponent>
            ...
            <Flex className={"adminProductRedactContentContainerProps"} direction={"column"} align={"center"}>
                ...
                <Switch checked={urlInput} size={"3"} style={{ marginTop: "20px", backgroundColor:"transparent"}} onCheckedChange={(checked) => setUrlInput(checked)} />
                ...
                <Flex align={"center"} direction={"row"} gap={"4"} style={{ marginTop: "20px" }}>
                    <AlertDialogCustom
                        description={"Ви точно хочете змінити цей продукт"}
                        buttonText={"Зберегти"}
                        buttonColor={"green"}
                        disabledText={!correct && "Ви ввели щось не так"}
                        isLoading={isLoading}
                        onSaveClick={correct && redactProduct}
                    />

                    <AlertDialogCustom
                        description={"Ви точно хочете скинути все що ви змінили"}
                        buttonText={"Скинути"}
                        buttonColor={"red"}
                        isLoading={isLoading}
                        onSaveClick={setDefault}
                    />
                </Flex>
                <p></p>
            </Flex>
