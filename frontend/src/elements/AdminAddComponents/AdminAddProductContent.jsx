        ...
        <DefaultComponent>
            ...
            <Flex className={"adminAddProductContentProps"} direction={"column"}>
                ...
                <Switch
                    ...
                    size={"3"}
                    style={{ marginTop: "20px",backgroundColor:"transparent",width:"100px"}}
                />
                ...
                <Box style={{ marginTop: "20px" }}>
                    <CustomInputWithCleaner
                        type={"text"}
                        placeholder={"Назва типу продукту"}
                        tooltipText={"Назва типу продукту"}
                        setValue={setTitle}
                        value={title}
                    />
                </Box>
                ...
                <Flex justify={"center"} direction={"row"} gap={"4"} style={{ marginTop: "20px" }}>
                    <AlertDialogCustom
                        ...
                        onSaveClick={correct && saveProduct}
                        isLoading={isLoading}
                    />
                    <AlertDialogCustom
                        description={"Ви точно хочете скинути данні?"}
                        buttonColor={"red"}
                        buttonText={"Скинути"}
